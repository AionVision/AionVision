...
class ChatResponse:
    """
        ...
        Attributes:
            ...
            model: Model used for generation (e.g. "claude-sonnet-4-20250514")
...
class ChatSessionDetail:
    """
        ...
        Attributes:
            ...
            selected_video_ids: IDs of selected videos for context
    ...
    def as_collection(self) -> 'FileCollection':
        ...
        Build a :class:`FileCollection` from search result IDs or selected images.
                ...
                to ``selected_image_ids`` + ``selected_video_ids``. Returns an empty
                collection when neither is present.
        """
        ...
