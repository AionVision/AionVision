...
class FilesResource:
    ...
    async def list(self, *, search: Optional[str] = None, search_mode: str = 'all', tags: Optional[list[str]] = None, date_from: Optional[datetime] = None, date_to: Optional[datetime] = None, has_description: Optional[bool] = None, ids: Optional[list[str]] = None, media_types: Optional[list[str]] = None, limit: int = 20, offset: int = 0, sort_by: str = 'content_created_at', sort_order: str = 'desc') -> FileList:
        """
                ...
                Args:
                    ...
                    media_types: Filter by media type - 'image', 'video', 'document', 'link'
    ...
    async def list_all(self, *, search: Optional[str] = None, search_mode: str = 'all', tags: Optional[list[str]] = None, date_from: Optional[datetime] = None, date_to: Optional[datetime] = None, has_description: Optional[bool] = None, media_types: Optional[list[str]] = None, sort_by: str = 'content_created_at', sort_order: str = 'desc', page_size: int = 50) -> AsyncIterator[UserFile]:
        """
