...
class BatchResource:
    ...
    async def submit_describe(self, images: list[BatchImageInput], *, providers: Optional[list[str]] = None, prompt: Optional[str] = None, max_parallel: int = 5, timeout_per_item: int = 30, rule_set_id: Optional[str] = None, rules: Optional[list[dict[str, Any]]] = None) -> BatchSubmissionResult:
        """
    ...
    async def submit_verify(self, pairs: list[BatchVerifyInput], *, providers: Optional[list[str]] = None, max_parallel: int = 5, timeout_per_item: int = 30, rule_set_id: Optional[str] = None, rules: Optional[list[dict[str, Any]]] = None) -> BatchSubmissionResult:
        """
