...
class VideoUploadError(AionvisionError):
    ...
    def __init__(self, message: str, *, media_id: Optional[str] = None, stage: Optional[str] = None, partial_chunks: int = 0) -> None:
        ...
...
class VideoAnalysisError(AionvisionError):
    ...
    def __init__(self, message: str, *, media_id: Optional[str] = None, analysis_job_id: Optional[str] = None, status: Optional[str] = None) -> None:
        ...
