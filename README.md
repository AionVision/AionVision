...
Detailed AI descriptions generated by VLM providers. Populated after describe operations complete.
| Field | Type | Description |
|-------|------|-------------|
...
| `confidence_score` | `float \| None` | AI confidence score (0-1) |
| `providers_used` | `list[str] \| None` | VLM providers used (e.g. `["anthropic"]`) |
| `verification_level` | `str \| None` | Verification level (quick/standard/thorough/critical) |
